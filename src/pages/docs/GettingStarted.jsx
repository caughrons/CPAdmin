...
function QuickStart() {
  return (
    <Box mb={10}>
      ...
      <Typography variant="subtitle1" gutterBottom my={4}>
        This project comes in two versions: one using{" "}
        <Link
        ...
        , giving you flexibility depending on your preferred development setup.
        Before using Mira, make sure Node.js is installed. You can find the
        required Node.js version in the <code>.nvmrc</code> file located in the
        project root.
      </Typography>
