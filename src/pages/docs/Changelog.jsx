        ...
        >
          ...
          <Box mt={3}>
            <Typography variant="subtitle1">
              <Chip color="secondary" label="v6.1.0" /> – Aug 30, 2025
              <ul>
                <li>Migrate to ESLint CLI</li>
                <li>Upgrade to MUI v7.3.1</li>
                <li>Upgrade to React v19.1.1</li>
                <li>Upgrade to Next.js v15.5.2</li>
                <li>Upgrade to Vite v6.3.5</li>
                <li>Upgrade to ApexCharts v4.7.0</li>
                <li>Upgrade to Node v22.19.0</li>
